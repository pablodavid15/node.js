...
app.get('/ola/:cargo/:nome/:idade/:cor/:ano', function(req, res){ // Função de callback com parametros nome, idade, cargo é cor
    res.send(`<h1>Ola, ${req.params.nome} e uma prazer :)!</h1><br><h2>Você tem ${req.params.idade} anos.</h2><br><h2>Você e ${req.params.cargo}.</h2><br><h3>Sua cor favorita ${req.params.cor}.<br></h3><h3>O ano é ${req.params.ano}</h3>`) // Mostrando o parametro nome, idade, cargo é cor
    /*
